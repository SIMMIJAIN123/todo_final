...
SECRET_KEY = 'django-insecure-gmaru#=k@-dkt=$gl6gsf*($lv2564lk7xgtxqaxriefyv95$9'
...
# CORS_ALLOWED_ORIGINS = [
#     "http://localhost:5173",  # React frontend URL in development
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=1),  # ⬅️ Increase access token to 1 day
